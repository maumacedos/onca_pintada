...
/***************** Configuration *****************/
  ...
  // Title prefixes
  $subject_title = "Mensagem do site Uniprotel:";
  $name_title = "Nome:";
  $email_title = "Email:";
  $message_title = "Assunto:";

  // Error messages
  $contact_error_name = "Nome é muito curto ou está vazio!";
  $contact_error_email = "Entre com um e-mail válido!";
  $contact_error_subject = "O assunto é muito curto ou está vazio!";
  $contact_error_message = "A mensagem é curta demais, escreva algo mais.";
